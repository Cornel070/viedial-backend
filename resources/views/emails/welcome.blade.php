...
<h1>Welcome to Viedial Health Care</h1>
	...
	<h3>Account Key</h3><br>
	<p>Your account key is: <strong>{{ $user->acct_key }}</strong></p><br>
	<p>This key is unique to your account and should be kept private. This key is also used to protect your data. It is also needed to log into your account and to access your health records on the app.</p><br>
